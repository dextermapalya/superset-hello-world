...
interface SupersetUiHelloWorldStylesProps {
  height: number;
  width: number;
...
export type SupersetUiHelloWorldProps = {
  height: number;
  width: number;
...
const Styles = styled.div<SupersetUiHelloWorldStylesProps>`
...
export default class SupersetUiHelloWorld extends PureComponent<SupersetUiHelloWorldProps> {
