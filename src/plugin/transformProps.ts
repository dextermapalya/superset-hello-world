...
interface SupersetUiHelloWorldDatum extends DataRecord {
...
export default function transformProps(chartProps: ChartProps) {
   ...
   * can also be accessed from your SupersetUiHelloWorld.tsx file, but
  ...
  const data = queryData.data as SupersetUiHelloWorldDatum[];
