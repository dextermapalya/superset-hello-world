 ...
 * under the License.
 */
import { SupersetUiHelloWorldChartPlugin } from '../src';
 ...
 */
describe('@superset-ui/plugin-chart-superset-ui-hello-world', () => {
  it('exists', () => {
    expect(SupersetUiHelloWorldChartPlugin).toBeDefined();
  });
});
